...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <form action="<?php echo e(route('admin.products.update', $data->_key)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-5">
                          ...
                          <div class="input-group input-group-merge">
                            <span class="input-group-text" id="basic-addon34"><?php echo e(route('admin.products.index')); ?>/</span>
                        ...
                        <div class="form-check form-switch mb-5">
                            <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" <?php echo e($data->is_featured == 1 ? 'checked' : ''); ?>>
                        ...
                        <div class="mb-5 d-flex align-items-center justify-content-between gap-5 overflow-hidden">
                            <div class="col-md-5">
                                ...
                                <input type="number" class="form-control border-radius-5" id="selling_price" name="selling_price" placeholder="Selling Price" step="any" value="<?php echo e($data->selling_price); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label for="original_price" class="form-label"><b>Original Price</b> <b class="text-danger">*</b></label>
                                <input type="number" class="form-control border-radius-5" id="original_price" name="original_price" placeholder="Selling Price" step="any" value="<?php echo e($data->original_price); ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body mt-4">
                        <select name="categories[]" id="categories" class="form-select select2search" data-control="select2" data-placeholder="Select an option" multiple>
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('admin.layouts.partials.category-option', ['category' => $category, 'level' => 0, 'selectedCategories' => $data->categories->pluck('id')->toArray()], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<script>
    ...
    ClassicEditor
            .create( document.querySelector( '#content' ), {
              ckfinder: {
                uploadUrl: "<?php echo e(route('admin.products.ckeditor.image.upload').'?_token='.csrf_token()); ?>"
              }
            } )
            .then((editor) => {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/anonymous/12a8dd6f-3122-4159-adcf-832ac2c3572d/laravel/cms_api_service/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>