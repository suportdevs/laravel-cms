    ...
    <table class="table table-hover" id="check">
        ...
        <tbody class="table-border-bottom-0">
            ...
            <tr>
                ...
                <td><a href="<?php echo e(route('admin.members.edit', $data->_key)); ?>"><?php echo e($data->first_name); ?> <?php echo e($data->last_name); ?></a></td>
                <td><a href="<?php echo e(route('admin.members.edit', $data->_key)); ?>"><?php echo e($data->email); ?></a></td>
                <td><a href="<?php echo e(route('admin.members.edit', $data->_key)); ?>"><?php echo e($data->phone); ?></a></td>
                ...
                <td>
                    <a class=" btn btn-icon btn-sm btn-primary" href="<?php echo e(route('admin.members.edit', $data->_key)); ?>"><i class="bx bx-edit-alt me-1"></i></a>
                    <a class=" btn btn-icon btn-sm btn-danger" href="javascript:void(0);" onclick="singleDelete('<?php echo e(route('admin.members.destroy', $data->_key)); ?>')"><i class="bx bx-trash me-1"></i></a>
                </td>
            </tr>
