                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="image-preview-wrapper">
                                            <img id="faviconLogoPreview" class="preview-image"
                                                data-default="https://cms.botble.com/vendor/core/core/base/images/placeholder.png"
                                                src="<?php echo e($data->getFirstMediaUrl('favicon') ?? 'https://cms.botble.com/vendor/core/core/base/images/placeholder.png'); ?>"
                                                alt="Preview image" style="width: 150px" />
                                            <button type="button"
                                                class="btn rounded-pill btn-icon btn-outline-secondary p-2 mt-2 d-none"
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="image-preview-wrapper">
                                            <img id="logoPreview" class="preview-image"
                                                data-default="https://cms.botble.com/vendor/core/core/base/images/placeholder.png"
                                                src="<?php echo e($data->getFirstMediaUrl('logo') ?? 'https://cms.botble.com/vendor/core/core/base/images/placeholder.png'); ?>"
                                                alt="Preview image" style="width: 150px" />
                                            <button type="button"
                                                class="btn rounded-pill btn-icon btn-outline-secondary p-2 mt-2 d-none"
