...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <form action="{{route('admin.blog.categories.update', $data->_key)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-8">
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-5">
                          ...
                          <div class="input-group input-group-merge">
                            <span class="input-group-text" id="basic-addon34">{{route('admin.blog.categories.index')}}/</span>
