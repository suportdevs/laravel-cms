<?php $__env->startPush('content'); ?>
    ...
    <div class="rts-b-creator-area rts-section-gapTop">
        <div class="container">
            <div class="row g-5">
                <!-- single step start -->
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_c_key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($_c_key <= 2): ?>
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="single-create" data-sal-delay="300" data-sal-duration="800" data-sal="slide-up">
                        <div class="wrapper">
                            <div class="thumb-ico">
                                <img src="<?php echo e($category->getFirstMediaUrl() ?: 'assets/images/icon/create/04.png'); ?>" alt="NFT-create-process">
                            </div>
                            <h6 class="title"><a href="<?php echo e(route('category.index', $category->permalink)); ?>"><?php echo e($category->name); ?></a></h6>
                            <P class="disc"><?php echo e($category->description); ?></P>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/anonymous/12a8dd6f-3122-4159-adcf-832ac2c3572d/laravel/cms_api_service/resources/views/frontend/home.blade.php ENDPATH**/ ?>