                            ...
                            <div class="tab-pane fade active show" id="list-general" role="tabpanel"
                                ...
                                <form id="generalForm" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="mb-5">
                                            <div class="image-preview-wrapper">
                                                <img id="bannerImagePreview" class="preview-image"
                                                    ...
                                                    src="{{$data->getFirstMediaUrl('banner_image') ?? 'https://cms.botble.com/vendor/core/core/base/images/placeholder.png'}}"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="site_description" id="site_description" rows="4" class="form-control">{{$data->general['site_description'] ?? ''}}</textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label for="address" class="mb-3"><b>Address</b></label>
                                        <input name="address" id="address" class="form-control"
                                            placeholder="Address..." value="{{$data->general['address'] ?? ''}}"/>
                                    </div>
                                    <div class="mb-4">
                                        <label for="website" class="mb-3"><b>Website</b></label>
                                        <input name="website" id="website" class="form-control"
                                            value="{{ $data->general['website'] ?? route('home') }}" />
                                    </div>
                                    <div class="mb-4">
                                        <label for="email" class="mb-3"><b>Email</b></label>
                                        <input type="email" name="email" id="email" class="form-control"
                                            placeholder="Email..." value="{{$data->general['email'] ?? ''}}" />
                                    </div>
                                    <div class="mb-4">
                                        <label for="site_title" class="mb-3"><b>Site Title</b></label>
                                        <input type="text" name="site_title" id="site_title" class="form-control"
                                            placeholder="Email..." value="{{$data->general['site_title'] ?? ''}}" />
                                    </div>
                                    <div class="mb-4">
                                        <label for="seo_title" class="mb-3"><b>SEO Title</b></label>
                                        <input type="text" name="seo_title" id="seo_title" class="form-control"
                                            placeholder="Email..." value="{{$data->general['seo_title'] ?? ''}}" />
                                    </div>
                                    <div class="mb-4">
                                        <label for="seo_description" class="mb-3"><b>SEO Description</b></label>
                                        <textarea name="seo_description" id="seo_description" rows="4" class="form-control">{{$data->general['seo_description'] ?? ''}}</textarea>
                                    </div>
                                    <div class="mb-5">
                                        ...
                                        <label for="indexYes" class="mb-3">
                                            <input name="is_index" class="form-check-input" type="radio" value="1"
                                                id="indexYes" {{($data->general['is_index'] ?? NULL) == 1 ? 'checked' : ''}} />
                                            <span>Index</span>
                                        </label>
                                        <label for="indexNo" class="mb-3">
                                            <input name="is_index" class="form-check-input" type="radio" value="0"
                                                id="indexNo" {{($data->general['is_index'] ?? NULL) == 0 ? 'checked' : ''}}/>
                                            <span>No Index</span>
                                        </label>
                                    </div>
                                    <div class="mb-5">
                                        ...
                                        <div class="image-preview-wrapper">
                                            <img id="seoImagePreview" class="preview-image"
                                                data-default="https://cms.botble.com/vendor/core/core/base/images/placeholder.png"
                                                src="{{$data->getFirstMediaUrl('seo_image') ?? 'https://cms.botble.com/vendor/core/core/base/images/placeholder.png'}}"
                                                alt="Preview image" style="width: 150px" />
                                            <button type="button"
                                                class="btn rounded-pill btn-icon btn-outline-secondary p-2 mt-2 d-none"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="copy_right" id="copy_right"
                                            rows="4" class="form-control">{{$data->general['copy_right'] ?? ''}}</textarea>
                                    </div>
                                    <div class="mb-3 position-relative">
                                        ...
                                        <select class="form-select" id="" name="date_format">
                                            <option value="M d, Y" {{($data->general['date_format'] ?? NULL) == 'M d, Y' ? 'selected' : ''}}>M d, Y (Nov 22, 2024)</option>
                                            <option value="F j, Y" {{($data->general['date_format'] ?? NULL) == 'F j, Y' ? 'selected' : ''}}>F j, Y (November 22, 2024)</option>
                                            <option value="F d, Y" {{($data->general['date_format'] ?? NULL) == 'F d, Y' ? 'selected' : ''}}>F d, Y (November 22, 2024)</option>
                                            <option value="Y-m-d" {{($data->general['date_format'] ?? NULL) == 'Y-m-d' ? 'selected' : ''}}>Y-m-d (2024-11-22)</option>
                                            <option value="Y-M-d" {{($data->general['date_format'] ?? NULL) == 'Y-M-d' ? 'selected' : ''}}>Y-M-d (2024-Nov-22)</option>
                                            <option value="d-m-Y" {{($data->general['date_format'] ?? NULL) == 'd-m-Y' ? 'selected' : ''}}>d-m-Y (22-11-2024)</option>
                                            <option value="d-M-Y" {{($data->general['date_format'] ?? NULL) == 'd-M-Y' ? 'selected' : ''}}>d-M-Y (22-Nov-2024)</option>
                                            <option value="m/d/Y" {{($data->general['date_format'] ?? NULL) == 'm/d/Y' ? 'selected' : ''}}>m/d/Y (11/22/2024)</option>
                                            <option value="M/d/Y" {{($data->general['date_format'] ?? NULL) == 'M/d/Y' ? 'selected' : ''}}>M/d/Y (Nov/22/2024)</option>
                                            <option value="d/m/Y" {{($data->general['date_format'] ?? NULL) == 'd/m/Y' ? 'selected' : ''}}>d/m/Y (22/11/2024)</option>
                                            <option value="d/M/Y" {{($data->general['date_format'] ?? NULL) == 'd/M/Y' ? 'selected' : ''}}>d/M/Y (22/Nov/2024)</option>
                                        </select>
