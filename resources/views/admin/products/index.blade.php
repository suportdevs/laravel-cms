...
@push('content')
    ...
    <div class="card postion-relative">
        ...
        <div class="card-header">
            <form action="{{route('admin.products.index')}}" method="POST" id="frmSearch">
                @csrf
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="">
                        <a href="{{route('admin.products.create')}}" class="btn btn-sm btn-primary"><i class="bx bx-plus"></i> Create</a>
        ...
        <form action="{{route('admin.products.delete')}}" id="frmList" method="POST">
            @csrf
            <div id="ajax_content">
