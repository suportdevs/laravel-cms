                        ...
                        <div class="card mb-5">
                            ...
                            <div id="pagesLinkBody" class="card-body mt-4 collapse show">
                                <div class="list-group">
                                    <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="list-group-item border-none px-0">
                                        <input class="form-check-input me-3" type="checkbox" name="menu_id" data-title<?php echo e($name); ?> data-reference-id="<?php echo e($id); ?>" data-reference-type="App\Models\Page" data-menu-id="<?php echo e($id); ?>" value="<?php echo e($id); ?>">
                                        <?php echo e($name); ?>
                            ...
                            <div id="categoriesLinkBody" class="card-body mt-4 collapse">
                                <div class="list-group">
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="list-group-item border-none px-0">
                                        <input class="form-check-input me-3" type="checkbox" name="menu_id" data-title<?php echo e($name); ?> data-reference-id="<?php echo e($id); ?>" data-reference-type="App\Models\Category" data-menu-id="<?php echo e($id); ?>" value="<?php echo e($id); ?>">
                                        <?php echo e($name); ?>
                            ...
                            <div id="tagsLinkBody" class="card-body mt-4 collapse">
                                <div class="list-group">
                                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id=>$name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="list-group-item border-none px-0">
                                        <input class="form-check-input me-3" type="checkbox" name="menu_id" data-title<?php echo e($name); ?> data-reference-id="<?php echo e($id); ?>" data-reference-type="App\Models\Tag" data-menu-id="<?php echo e($id); ?>" value="<?php echo e($id); ?>">
                                        <?php echo e($name); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text" id="basic-addon34"><?php echo e(route('admin.blog.menus.index')); ?>/</span>
                                    <input type="text" class="form-control" name="permalink" id="permalink" value="<?php echo e($data->permalink); ?>" required>
                                </div>
                                </div>
                                <div class="mb-5">
                                    <label for="description" class="form-label">Description</label>
                                    <textarea name="description" id="description" rows="3" class="form-control border-radius-5" placeholder="Description"><?php echo e($data->description); ?></textarea>
                                </div>
                            </div>
                        </div>
