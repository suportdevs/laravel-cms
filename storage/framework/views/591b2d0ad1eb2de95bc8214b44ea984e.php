        ...
        <div class="menu-structure-node-content p-5" id="menu-structure-node-form" style="border:1px solid #ccc; border-top: none;">
            ...
            <div class="mb-3 position-relative">
                ...
                <select class="form-control" id="custom-menu-node-target-new" name="target">
                    <option value="_self" <?php echo e((isset($item['target']) && $item['target'] == '_self') ? "seleted" : ''); ?>>Open link directly</option>
                    <option value="_blank" <?php echo e((isset($item['target']) && $item['target'] == '_blank') ? "seleted" : ''); ?>>Open link in new tab</option>
                </select>
            </div>
