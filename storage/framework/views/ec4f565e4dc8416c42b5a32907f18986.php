...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <!-- Blogs -->
      <li class="menu-item <?php echo e(request()->routeIs('admin.blog.posts.*') || request()->routeIs('admin.blog.categories.*') || request()->routeIs('admin.blog.tags.*') ? 'active open' : ''); ?>">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bx-file"></i>
          <div class="text-truncate" data-i18n="Blogs">Blogs</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item <?php echo e(request()->routeIs('admin.blog.posts.*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('admin.blog.posts.index')); ?>" class="menu-link ">
          ...
          <li class="menu-item <?php echo e(request()->routeIs('admin.blog.tags.*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('admin.blog.tags.index')); ?>" class="menu-link">
      ...
      <li class="menu-item <?php echo e(request()->routeIs('admin.theme.*') ? 'active open' : ''); ?>">
        ...
        <ul class="menu-sub">
          ...
          <li class="menu-item <?php echo e(request()->routeIs('admin.theme.settings.*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('admin.theme.settings')); ?>" class="menu-link">
