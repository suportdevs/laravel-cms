...
<div class="container-xxl flex-grow-1 container-p-y">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="<?php echo e(route('admin.blog.categories.index')); ?>">Categories</a>
        </li>
        <li class="breadcrumb-item active">Edit ** <?php echo e($data->name); ?> **</li>
        </ol>
    </nav>
    <form action="<?php echo e(route('admin.blog.categories.update', $data->_key)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-5">
                          ...
                          <div class="input-group input-group-merge">
                            <span class="input-group-text" id="basic-addon34"><?php echo e(route('admin.blog.categories.index')); ?>/</span>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/anonymous/12a8dd6f-3122-4159-adcf-832ac2c3572d/laravel/cms_api_service/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>