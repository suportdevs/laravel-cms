    ...
    <table class="table table-hover" id="check">
        ...
        <tbody class="table-border-bottom-0">
            ...
            <tr>
                ...
                <td><a href="<?php echo e(route('admin.products.edit', $data->_key)); ?>"><?php echo e($data->name); ?></a></td>
                ...
                <td>
                    <a class=" btn btn-icon btn-sm btn-primary" href="<?php echo e(route('admin.products.edit', $data->_key)); ?>"><i class="bx bx-edit-alt me-1"></i></a>
                    <a class=" btn btn-icon btn-sm btn-danger" href="javascript:void(0);" onclick="singleDelete('<?php echo e(route('admin.products.destroy', $data->_key)); ?>')"><i class="bx bx-trash me-1"></i></a>
                </td>
            </tr>
...
<?php /**PATH /media/anonymous/12a8dd6f-3122-4159-adcf-832ac2c3572d/laravel/cms_api_service/resources/views/admin/products/_list.blade.php ENDPATH**/ ?>