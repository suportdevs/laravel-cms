                      ...
                      <div class="mb-5">
                        ...
                        <div class="mb-5 d-flex align-items-center justify-content-between gap-5 overflow-hidden">
                            <div class="col-md-5">
                                ...
                                <input type="number" class="form-control border-radius-5" id="selling_price" name="selling_price" placeholder="Selling Price" step="any" required>
                            </div>
                            <div class="col-md-6">
                                <label for="original_price" class="form-label"><b>Original Price</b> <b class="text-danger">*</b></label>
                                <input type="number" class="form-control border-radius-5" id="original_price" name="original_price" placeholder="Selling Price" step="any" required>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body mt-4">
                        <select name="categories[]" id="categories" class="form-select select2search" data-control="select2" data-placeholder="Select an option" multiple>
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php echo $__env->make('admin.layouts.partials.category-option', ['category' => $category, 'level' => 0], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/anonymous/12a8dd6f-3122-4159-adcf-832ac2c3572d/laravel/cms_api_service/resources/views/admin/products/create.blade.php ENDPATH**/ ?>