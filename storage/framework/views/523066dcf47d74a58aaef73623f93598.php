                            ...
                            <div id="tagsLinkBody" class="card-body mt-4 collapse">
                                <div class="list-group">
                                    <?php $__currentLoopData = $tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="list-group-item border-none px-0">
                                        <input class="form-check-input me-3" type="checkbox" name="menu_id" data-title="<?php echo e($value->name); ?>" data-reference-id="<?php echo e($value->id); ?>" data-reference-type="App\Models\Tag" data-menu-id="<?php echo e($value->id); ?>" ddata-link="<?php echo e($value->permalink); ?>" data-label="Tag" value="<?php echo e($value->id); ?>">
                                        <?php echo e($value->name); ?>
