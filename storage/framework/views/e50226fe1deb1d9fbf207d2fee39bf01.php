...
<div class="container-xxl flex-grow-1 container-p-y">
    <nav aria-label="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="<?php echo e(route('admin.blog.posts.index')); ?>">Posts</a>
        </li>
        <li class="breadcrumb-item active">Edit ** <?php echo e($data->name); ?> **</li>
        </ol>
    </nav>
    <form action="<?php echo e(route('admin.blog.posts.update', $data->_key)); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                      ...
                      <div class="mb-5">
                          ...
                          <div class="input-group input-group-merge">
                            <span class="input-group-text" id="basic-addon34"><?php echo e(route('admin.blog.posts.index')); ?>/</span>
                ...
                <div class="card mb-5">
                    ...
                    <div class="card-body mt-4">
                        <select name="tags[]" id="tags" class="form-select select2search" data-control="select2" data-placeholder="Select an option" multiple>
                            ...
                            ?>
                                <option value="<?php echo e($id); ?>" <?php echo e(in_array($id, $selectedTags) ? 'selected' : ''); ?>><?php echo e($name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                </div>
...
<script>
    ...
    ClassicEditor
            .create( document.querySelector( '#content' ), {
              ckfinder: {
                uploadUrl: "<?php echo e(route('admin.blog.posts.ckeditor.image.upload').'?_token='.csrf_token()); ?>"
              }
            } )
            .then((editor) => {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/anonymous/12a8dd6f-3122-4159-adcf-832ac2c3572d/laravel/cms_api_service/resources/views/admin/posts/edit.blade.php ENDPATH**/ ?>